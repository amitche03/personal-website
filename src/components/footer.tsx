...
const socialLinks = [
  ...
  {
    href: "mailto:mitche.the.dev@gmail.com",
    label: "Email",
    icon: (
      <svg
        className="h-5 w-5"
    ...
    <footer className="mt-16 border-t border-white/10">
      <div className="mx-auto max-w-7xl px-5 py-12 md:px-8">
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div>
            ...
            <p className="mt-2 text-sm text-white/60">
              Software Engineer building data-driven products in the Bay Area.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex w-48 justify-between px-4">
            ...
            <a
              ...
              className="mt-5 flex w-48 items-center justify-center gap-2 rounded-full border border-white/10 px-4 py-2 text-sm text-white/70 transition-all hover:border-emerald-500/30 hover:text-white"
            >
              Download Resume
              <svg
                className="h-4 w-4"
        ...
        <div className="mt-10 flex flex-col items-center justify-between gap-4 border-t border-white/10 pt-8 text-sm text-white/40 md:flex-row">
          <p>
            © {new Date().getFullYear()} Mitchell Anderson. All rights
            reserved.
          </p>
        </div>
      </div>
